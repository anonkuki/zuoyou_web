...
describe('BlogPostBoard', () => {
  it('renders pinned, member-selected and newest posts for a department', async () => {
    const post = { id: 'post-1', title: '幻装工坊日志', subtitle: '道具上色记录', content: '今天完成了上色。', body: [], departmentName: 'COS部', pinned: true, featured: true, voteCount: 3, commentCount: 0, createdAt: '2026-08-20T08:00:00.000Z', author: { id: 'member-1', displayName: '白羽', avatarColor: '#fff' } };
