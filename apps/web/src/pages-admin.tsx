  ...
  return <main>
    ...
    <section className="shell">
      {open&&<form className="inline-create" onSubmit={e=>{e.preventDefault();upload.mutate();}}>
        ...
        <label>所属部门<select value={departmentId} disabled={user?.role!=='ADMIN'} onChange={e=>setDepartmentId(e.target.value)}><option value="dept-cos">COS部</option><option value="dept-tech">技术部</option><option value="dept-music">轻音部</option><option value="dept-original">原创部</option><option value="dept-dance">舞装部</option><option value="dept-publicity">外宣&amp;幻想研</option></select></label>
