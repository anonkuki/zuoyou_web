...
import { ActivitiesPage, ActivityDetailPage, AnnouncementDetailPage, AnnouncementsPage, ApplicationStatusPage, ChroniclePage, DepartmentDetailPage, DepartmentsPage, ForumBoardPage, JoinPage, NotFoundPage, WorksPage } from './pages-public';
