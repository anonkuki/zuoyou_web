...
const portalLinks=[
  ['/portal',LayoutDashboard,'个人总览'],['/portal/profile',UserRound,'编辑资料'],['/portal/members',Users,'成员名录'],['/portal/world',Gamepad2,'像素广场'],['/portal/tavern',ScrollText,'发帖与作品上传'],['/portal/match',Sparkles,'共鸣图鉴'],['/portal/chat',MessageCircle,'公会通讯'],['/portal/activities',Activity,'活动报名'],['/portal/tasks',ClipboardCheck,'部门任务'],['/portal/files',FileArchive,'内部文件'],
] as const;
const adminLinks=[
