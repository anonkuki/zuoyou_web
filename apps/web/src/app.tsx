...
import { ActivitiesPage, ActivityDetailPage, AnnouncementDetailPage, AnnouncementsPage, ApplicationStatusPage, ChroniclePage, DepartmentDetailPage, DepartmentsPage, ForumBoardPage, JoinPage, NotFoundPage, TavernPage, WorksPage } from './pages-public';
...
import { LegacyPostDetailPage, MatchPage, PostsPage, PublicPostPage } from './pages-tavern';
...
function AppRoutes() {
  ...
  const routes = <Routes location={location}>
    <Route element={<PublicLayout/>}><Route index element={<HomePage/>}/><Route path="chronicle" element={<ChroniclePage/>}/><Route path="departments" element={<DepartmentsPage/>}/><Route path="departments/:slug" element={<DepartmentDetailPage/>}/><Route path="page-history/home" element={<PageHistoryPage scope="home"/>}/><Route path="page-history/department/:slug" element={<PageHistoryPage scope="department"/>}/><Route path="posts/:id" element={<PublicPostPage/>}/><Route path="activities" element={<ActivitiesPage/>}/><Route path="activities/:id" element={<ActivityDetailPage/>}/><Route path="announcements" element={<AnnouncementsPage/>}/><Route path="announcements/:id" element={<AnnouncementDetailPage/>}/><Route path="tavern" element={<TavernPage/>}/><Route path="tavern/:departmentSlug" element={<ForumBoardPage/>}/><Route path="tavern/:departmentSlug/:subboardId" element={<ForumBoardPage/>}/><Route path="works" element={<WorksPage/>}/><Route path="join" element={<JoinPage/>}/><Route path="application/:token" element={<ApplicationStatusPage/>}/></Route>
    <Route path="login" element={<LoginPage/>}/>
    <Route path="activate" element={<ActivatePage/>}/>
    <Route path="portal" element={<Protected><ConsoleLayout/></Protected>}><Route index element={<PortalHomePage/>}/><Route path="profile" element={<ProfileEditorPage/>}/><Route path="avatar" element={<AvatarStudioPage/>}/><Route path="members" element={<MemberDirectoryPage/>}/><Route path="members/:id" element={<MemberHomepagePage/>}/><Route path="tavern" element={<PostsPage/>}/><Route path="tavern/:id" element={<LegacyPostDetailPage/>}/><Route path="match" element={<MatchPage/>}/><Route path="world" element={<WorldLobbyPage/>}/><Route path="world/:areaId" element={<WorldAreaPage/>}/><Route path="chat" element={<ChatPage/>}/><Route path="activities" element={<MemberActivitiesPage/>}/><Route path="works" element={<MemberWorksPage/>}/><Route path="tasks" element={<MemberTasksPage/>}/><Route path="files" element={<MemberFilesPage/>}/></Route>
    <Route path="admin" element={<Protected manager><ConsoleLayout admin/></Protected>}><Route index element={<AdminIndex/>}/><Route path="page-editor/home" element={<PageEditorPage scope="home"/>}/><Route path="page-editor/department/:slug" element={<PageEditorPage scope="department"/>}/><Route path="members" element={<MembersAdminPage/>}/><Route path="departments" element={<Protected adminOnly><DepartmentsAdminPage/></Protected>}/><Route path="activities" element={<ActivitiesAdminPage/>}/><Route path="announcements" element={<Protected adminOnly><AnnouncementsAdminPage/></Protected>}/><Route path="recruitment" element={<RecruitmentAdminPage/>}/><Route path="works" element={<WorksAdminPage/>}/><Route path="files" element={<FilesAdminPage/>}/><Route path="tasks" element={<TasksAdminPage/>}/><Route path="history" element={<Protected adminOnly><ChronicleAdminPage/></Protected>}/><Route path="analytics" element={<Protected adminOnly><AnalyticsAdminPage/></Protected>}/><Route path="settings" element={<Protected adminOnly><SettingsAdminPage/></Protected>}/><Route path="audit" element={<Protected adminOnly><AuditAdminPage/></Protected>}/></Route>
